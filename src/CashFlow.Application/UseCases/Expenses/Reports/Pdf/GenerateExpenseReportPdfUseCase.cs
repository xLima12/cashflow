...
public class GenerateExpenseReportPdfUseCase : IGenerateExpenseReportPdfUseCase
{
    ...
    public async Task<byte[]> Execute(DateOnly month)
    {
        ...
        foreach ( var expense in expenses)
        {
            ...
            if (string.IsNullOrWhiteSpace(expense.Description) == false)
            {
                ...
                descriptionRow.Cells[0].Format.Font = new Font { Name = FontHelper.LATO_REGULAR, Size = 10, Color = ColorsHelper.BLACK };
    ...
    private Document CreateDocument(DateOnly month)
    {
        ...
        document.Info.Author = "Felipe Lima";

        var style = document.Styles["Normal"];
        style!.Font.Name = FontHelper.MONTSERRAT_REGULAR;
    ...
    private void CreateHeaderWithProfilePhotoAndName(Section page)
    {
        ...
        row.Cells[1].AddParagraph("Hey, Felipe Lima");
        row.Cells[1].Format.Font = new Font { Name = FontHelper.LATO_BLACK, Size = 16 };
    ...
    private void CreateTotalSpentSection(Section page, DateOnly month, decimal totalExpenses)
    {
        ...
        paragraph.AddFormattedText($"{totalExpenses} {CURRENCY_SYMBOL}", new Font { Name = FontHelper.LATO_BLACK, Size = 50 });
    }
    ...
    {
        cell.Format.Font = new Font { Name = FontHelper.LATO_REGULAR, Size = 12, Color = ColorsHelper.BLACK };
    ...
    private void AddAmountForExpense(Cell cell, decimal amount)
    {
        ...
        cell.Format.Font = new Font { Name = FontHelper.LATO_REGULAR, Size = 14, Color = ColorsHelper.BLACK };
